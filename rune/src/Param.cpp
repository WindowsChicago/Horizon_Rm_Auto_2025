// #include "../../include/rune/Param.h"
// #ifdef Rune

// namespace power_rune {

// Param::Param(const std::string& filename,const std::string& filename1) { load(filename,filename1); }

// void Param::load(const std::string& filename,const std::string& filename1) {
...
//     loadcamera(filename1);
// }
// void Param::loadcamera(const std::string& filename1){
//     cv::FileStorage fs(filename1, cv::FileStorage::READ);
//     fs["M1"] >> INTRINSIC_MATRIX;
//     fs["D1"] >> DIST_COEFFS;
// }
